...
<?php 
 	...
 	if (isset($_POST['btn_save'])) {
 		...
 		$query="insert into teacher_salary_allowances(teacher_id,basic_salary,medical_allowance)values('$teacher_id','$basic_salary','$medical_allowance')";
 	...
 	if (isset($_POST['btn_sub'])) {
 		...
 		while ($row=mysqli_fetch_array($run)) {
 			$total_amount=$row['basic_salary']+($row['basic_salary']*$row['medical_allowance']/100);
