								...
								<div class="col-md-4">
									<div class="form-group" style="z-index: 10;">
										...
										<select class="browser-default custom-select" name="course_name">
											...
											$query="select distinct(course_name) from teacher_courses where teacher_id='$teacher_id'";
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<select class="browser-default custom-select" name="subject_code" required="">
											...
											<?php
											$teacher_id=$_SESSION['teacher_id'];
											$query="select distinct(subject_name) from teacher_courses where teacher_id='$teacher_id'";
											$run=mysqli_query($con,$query);
											while($row=mysqli_fetch_array($run)) {
